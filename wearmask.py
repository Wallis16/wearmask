...
def face_alignment(faces):
    # 预测关键点
    predictor = dlib.shape_predictor("/home/diogenes/Desktop/create_face_mask/wear_mask_to_face/shape_predictor_68_face_landmarks.dat")
    faces_aligned = []
    for face in faces:
    ...
    def mask(self):
        ...
        if found_face:
            ...
            if mode == 'face_image':
                ...
                #cv2.imwrite('face_mask.jpg',detect_face)
